...
sysTestResMenuPathInitVal = {
                             'a': {'passed': [], 'failed': [], 'error': [], 'a': '/aSys'},
                             'AC': {'passed': ['Passed'], 'failed': [], 'error': [], 'AC': '/acSys'},
                             'AF': {'passed': ['Passed'], 'failed': ['Failed'], 'error': [''], 'AF': '/afSys'},
                             'B': {'passed': [], 'failed': [], 'error': [], 'B': '/bSys'},
                             'C': {'passed': [], 'failed': [], 'error': [], 'C': '/cSys'},
                             'CODE': {'passed': [], 'failed': [], 'error': [], 'CODE': '/codeSys'},
                             'FSD': {'passed': [], 'failed': [], 'error': [], 'FSD': '/fsdSys'},
                             'TD': {'passed': ['Passed'], 'failed': [], 'error': [], 'TD': '/tdSys'},
                             'TP': {'passed': ['Passed'], 'failed': [], 'error': [], 'TP': '/tpSys'},
